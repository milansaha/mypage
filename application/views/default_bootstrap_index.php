...
<head>
    ...
    <link href="<?php echo base_url();?>media/css/prettyPhoto.css" rel="stylesheet">
    ...
    <header class="navbar navbar-inverse navbar-fixed-top wet-asphalt" role="banner">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img src="<?php echo base_url();?>media/images/logo.png" alt="logo"></a>
            </div>
    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide wet-asphalt">
            ...
            <div class="carousel-inner">
                <div class="item active" style="background-image: url(<?php echo base_url();?>media/images/slider/bg1.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="item" style="background-image: url(<?php echo base_url();?>media/images/slider/bg2.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="item" style="background-image: url(<?php echo base_url();?>media/images/slider/bg3.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content centered">
                            ...
                            <div class="item active">
                                <div class="row">
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo base_url();?>media/images/portfolio/recent/item1.png" alt="">
                                                <h5>
                                                    Nova - Corporate site template
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="Malesuada fames ac turpis egestas" href="<?php echo base_url();?>media/images/portfolio/full/item1.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>                            
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo base_url();?>media/images/portfolio/recent/item3.png" alt="">
                                                <h5>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                <img class="img-responsive" src="<?php echo base_url();?>media/images/portfolio/recent/item2.png" alt="">
                                                <h5>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div>
                        <div class="media">
                            <div class="pull-left">
                                <img src="<?php echo base_url();?>media/images/blog/thumb1.jpg" alt="">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img src="<?php echo base_url();?>media/images/blog/thumb2.jpg" alt="">
                            </div>
                            <div class="media-body">
                                <span class="media-heading"><a href="#">Pellentesque habitant morbi tristique senectus</a></span>
                        ...
                        <div class="media">
                            <div class="pull-left">
                                <img src="<?php echo base_url();?>media/images/blog/thumb3.jpg" alt="">
                            </div>
                            <div class="media-body">
                                <span class="media-heading"><a href="#">Pellentesque habitant morbi tristique senectus</a></span>
